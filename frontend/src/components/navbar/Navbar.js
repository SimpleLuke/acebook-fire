...
const Navbar = ({ navigate, userData, storeUserData }) => {
  ...
  return (
    <div className="pb-16">
      <nav className="z-50 fixed top-0 left-0 right-0 h-16 p2 pt-9 pb-9 mx-auto place-content-between  px-5 bg-red-200 flex items-center">
        <div
        ...
        <div className="flex justify-between">
          <div
            className="p-2 right-0 text-lg text-red-500 cursor-default "
